...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "Social Media Map Application.Android.dll" comes first in this list. */
		"Social Media Map Application.Android.dll",
		"BruTile.dll",
		"Fizzler.dll",
		"FormsViewGroup.dll",
		"HarfBuzzSharp.dll",
		...
		"Social Media Map Application.dll",
		"Svg.Custom.dll",
		"Svg.Model.dll",
		"Svg.Skia.dll",
